...
<?php
    ...
    $query = "INSERT INTO comprados (usuario_comprador, Codigo_piso, precio_final) VALUES ('$id', '$codigo_piso','$precio')";



    if (mysqli_query($conn, $query)) {
        echo "<div class='portada_1'>";
        echo "<div class='cuadrado3'><p class='correcto'>PISO COMPRADO</p></div>";
        echo "</div>";
      } else {
        echo "<div class='portada_1'>";
