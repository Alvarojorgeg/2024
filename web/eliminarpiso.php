...
$queryComprados = "DELETE FROM pisos WHERE codigo_piso='$codigo_piso';";
// Ejecutar las consultas
if (mysqli_query($conn, $queryComprados)) {
    echo "<div class='portada_1'>";
    echo "<div class='cuadrado3'><p class='correcto'>PISO ELIMINADO</p></div>";
    echo "</div>";
} else {
    echo "<div class='portada_1'>";
    echo "<div class='cuadrado3'><p class='nohayresultado'>ERROR AL ELIMINAR</p></div>";
    echo "</div>";
}
